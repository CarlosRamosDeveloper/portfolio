export const projects = {
  items: {
    1: {
      name: 'RPG-Navegador',
      shortDescription:
        ' enJuego de navegador desarrollado como proyecto final de DAW',
      description: [
        '  en Solo con una pantalla, pero modificando la interfaz en función de las elecciones del usuario',
        'en El proyecto podia funcionar de forma standalone en navegador, almacenando los datos en el localStorage',
        'Un en proyecto para clase que se fue de las manos y creció sin control',
